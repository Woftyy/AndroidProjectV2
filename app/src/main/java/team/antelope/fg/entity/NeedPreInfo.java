 ...
 * @Author hwc
 * @Date 2018/1/6
 * @TODO NeedPreInfo 模块部分信息
 *
 */
public class NeedPreInfo {
	private Long id;
	private Long uid;
	private String name;
	...
	public NeedPreInfo(Long id, Long uid, String name, String headimg, Double longitude, Double latitude, String title,
			String addressdesc) {
		super();
		this.id = id;
		this.uid = uid;
	...
	public String toString() {
		return "NeedPreInfo [id=" + id + ", uid=" + uid + ", name=" + name + ", headimg=" + headimg + ", longitude="
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		NeedPreInfo other = (NeedPreInfo) obj;
		if (addressdesc == null) {
