package team.antelope.fg.customized.searchview;
...
public class SearchView extends LinearLayout {
    ...
    */
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        int defaultColor = context.getResources().getColor(R.color.colorSearchText); // 默认颜色 = 灰色
        ...
        // 搜索框高度
        searchBlockHeight = typedArray.getInteger(R.styleable.Search_View_searchBlockHeight, 110);

        // 搜索框颜色
        int defaultColor2 = context.getResources().getColor(R.color.colorSearchDefault); // 默认颜色 = 白色
...
//                    Toast.makeText(context.getApplicationContext(), "需要搜索的是" + et_search.getText(), Toast.LENGTH_SHORT).show();
...
//                Toast.makeText(context.getApplicationContext(), "返回到上一页", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    /**
    * @说明 绑定搜索框xml视图
    * @创建日期 2017/12/9 下午8:13
    */
    private void initView(){

        // 1. 绑定R.layout.search_layout作为搜索框的xml文件
        LayoutInflater.from(context).inflate(R.layout.lx_search_layout,this);
    ...
    /**
    * @说明 模糊查询数据 & 显示到ListView列表上
    * @创建日期 2017/12/9 下午8:08
    */
