package team.antelope.fg.ui.dialog;
...
public class BaseDialog extends Dialog implements
	...
	private Button BUTTON_POSITIVE;// 底部按钮BUTTON_POSITIVE
	private Button BUTTON_NEUTRAL;// 底部按钮BUTTON_NEUTRAL
	private Button BUTTON_NEGATIVE;// 底部按钮BUTTON_NEGATIVE
	...
	private void initViews() {
		...
		BUTTON_POSITIVE = (Button) findViewById(R.id.dialog_generic_btn_button1);
		BUTTON_NEUTRAL = (Button) findViewById(R.id.dialog_generic_btn_button2);
		BUTTON_NEGATIVE = (Button) findViewById(R.id.dialog_generic_btn_button3);
	...
	private void initEvents() {
		BUTTON_POSITIVE.setOnClickListener(this);
		BUTTON_NEUTRAL.setOnClickListener(this);
	...
	public void setButton2(CharSequence text,
		...
		if (text != null && listener != null) {
			mLayoutBottom.setVisibility(View.VISIBLE);
			BUTTON_NEUTRAL.setVisibility(View.VISIBLE);
			BUTTON_NEUTRAL.setText(text);
	...
	public void setButton1Background(int id) {
		BUTTON_POSITIVE.setBackgroundResource(id);
	}

	public void setButton2Background(int id) {
		BUTTON_NEUTRAL.setBackgroundResource(id);
	}

	public void setButton3Background(int id) {
		BUTTON_NEGATIVE.setBackgroundResource(id);
	}
